...
2. dispatch_once 
    ...
    ```objc
        ...
        {
            if (DISPATCH_EXPECT(*predicate, ~0l) != ~0l) {//判断predicate
        ...
        {//重点
            ...
            if (os_atomic_cmpxchg(vval, NULL, tail, acquire)) {//判断vval是否为NULL
                ...
                for (;;) {//死循环查询vval 
                    ...
                    if (os_atomic_cmpxchgv(vval, next, tail, &next, release)) {//内核操作
